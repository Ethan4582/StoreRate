...
import { User as UserIcon, Mail, Shield, Calendar, Store, Star, Lock, PlusCircle, Bookmark, Eye, Activity, Edit } from "lucide-react"
  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 mb-1">User Profile</h1>
          <p className="text-sm text-slate-500">View detailed account information for {user.name}</p>
        </div>
      </div>
        ...
        <Card className="rounded-2xl shadow-sm border-slate-200">
          <CardContent className="p-6 flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-[10px] text-slate-500">Total stores user added</div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="rounded-2xl shadow-sm border-slate-200 opacity-60">
          <CardContent className="p-6 flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-[10px] text-slate-500">People viewed profile</div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="rounded-2xl shadow-sm border-slate-200 opacity-60">
          <CardContent className="p-6 flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-[10px] text-slate-500">Stores user saved</div>
            </div>
          </CardContent>
        </Card>
      </div>
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-0">
              ...
              <div className="flex items-center justify-between py-3 border-b border-slate-100">
                ...
                <span className="text-sm text-slate-900 font-medium text-left flex-1">{(user as any).address || "Not provided"}</span>
              </div>
        ...
        <Card className="rounded-2xl shadow-sm border-slate-200">
          <CardContent className="p-6">
            ...
            <div className="bg-blue-50/50 border border-blue-100 rounded-xl p-4 mb-6 flex items-start gap-3">
              ...
              <div>
                <h4 className="text-sm font-semibold text-slate-900">User security status</h4>
                <p className="text-xs text-slate-500 mt-1">This user's account is protected by standard authentication.</p>
              </div>
            </div>
